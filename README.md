...
- 数据统计（Model 数据底座已实现、界面尚未实现）：Schema v4 已通过任务事件支持今日/本周完成、同期变化、按时率、当前任务健康和类别构成聚合；后续再使用纯 Qt Widgets + Qt Charts 展示近 7 天、近 30 天和近 12 周趋势。详细方案见[数据统计设计](docs/statistics-design.md)。
